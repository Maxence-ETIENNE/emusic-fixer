...
class __TwigTemplate_d43cee056d8e8c78a323716d950ac482 extends Template
{
    ...
    <a href=\"";
        // line 59
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_instrument_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["instrument"]) || array_key_exists("instrument", $context) ? $context["instrument"] : (function () { throw new RuntimeError('Variable "instrument" does not exist.', 59, $this->source); })()), "id", [], "any", false, false, false, 59)]), "html", null, true);
...
";
    ...
    {
        return array (  210 => 61,  205 => 59,  201 => 58,  196 => 56,  190 => 52,  181 => 48,  179 => 47,  172 => 46,  167 => 45,  159 => 40,  152 => 36,  145 => 32,  138 => 28,  131 => 24,  124 => 20,  117 => 16,  110 => 12,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    <a href=\"{{ path('app_instrument_edit', {'id': instrument.id}) }}\" class=\"btn btn-primary\">Modifier</a>
