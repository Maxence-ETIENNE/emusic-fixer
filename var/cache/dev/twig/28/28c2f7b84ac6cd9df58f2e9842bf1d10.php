...
class __TwigTemplate_169eb347de60a8b2e8d93957fb49667a extends Template
{
    ...
    <button class=\"btn btn-primary\">
        ";
        // line 4
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("button_label", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 4, $this->source); })()), "Sauvegarder")) : ("Sauvegarder")), "html", null, true);
        yield "
    </button>
";
        // line 6
...
{{ form_end(form) }}
", "cours/_form.html.twig", "D:\\wamp2024\\www\\emusic\\templates\\cours\\_form.html.twig");
    }
}
