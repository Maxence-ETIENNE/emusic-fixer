...
class __TwigTemplate_555189e43054b06e7d89c677dce37e83 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 11, $this->source); })()), "user", [], "any", false, false, false, 11)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            yield " (Rôle: ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 13, $this->source); })()), "user", [], "any", false, false, false, 13), "roles", [], "any", false, false, false, 13), 0, [], "array", false, false, false, 13), "html", null, true);
            yield "), <a href=\"";
...
";
    ...
    {
        return array (  140 => 22,  134 => 19,  129 => 16,  119 => 13,  116 => 12,  114 => 11,  111 => 10,  105 => 8,  103 => 7,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    <form method=\"post\">
        ...
        {% if app.user %}
            <div class=\"mb-3\">
                Vous êtes connecté en tant que {{ app.user.userIdentifier }} (Rôle: {{ app.user.roles[0] }}), <a href=\"{{ path('app_logout') }}\">Se déconnecter</a>
            </div>
        {% endif %}
...
{% endblock %}
", "security/login.html.twig", "D:\\wamp2024\\www\\emusic\\templates\\security\\login.html.twig");
    }
}
